...
export default function MagiReport({ data }: MagiReportProps) {
  ...
  const units = [
    { key: "melchior", label: "MELCHIOR-1", sub: t.report.unitSubs.melchior, resp: data.melchior },
    { key: "balthasar", label: "BALTHASAR-2", sub: t.report.unitSubs.balthasar, resp: data.balthasar },
    { key: "casper", label: "CASPER-3", sub: t.report.unitSubs.casper, resp: data.casper },
  ] as const;
  ...
  return (
    ...
    >
      ...
      <div className="px-3 sm:px-4 py-2 border-b" style={{ borderColor: "#1a1a1a" }}>
        <span className="text-gray-600">{t.report.query}: </span>
